    ...
    <template v-slot:content>
      <div class="container">
        <form @submit.prevent="onSubmit">
          <div class="body">
            <CustomInput type="text" name="name" label="Name:" v-model="v.name.$model" :errors="v.name.$errors" />
            <CustomInput
              type="text"
              name="description"
              label="Description:"
            ...
            />
            <CustomInput type="number" name="price" label="Price:" v-model="v.price.$model" :errors="v.price.$errors" />
          </div>
